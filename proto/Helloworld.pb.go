...
var file_proto_Helloworld_proto_rawDesc = []byte{
	...
	0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x54, 0x77, 0x69, 0x63, 0x65, 0x12, 0x13, 0x2e,
...
var file_proto_Helloworld_proto_depIdxs = []int32{
	...
	0, // 1: proto.Greeter.SayHelloTwice:input_type -> proto.HelloRequest
	1, // 2: proto.Greeter.SayHello:output_type -> proto.HelloReply
	1, // 3: proto.Greeter.SayHelloTwice:output_type -> proto.HelloReply
...
func (c *greeterClient) SayHelloTwice(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/proto.Greeter/SayHelloTwice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHelloTwice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Greeter/SayHelloTwice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
